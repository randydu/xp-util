...
class TRefObj : public T {
  ...
  public:
    ...
    TRefObj(Ts... args) : T(args...), _count(0) {}
...
class TInterface : public T {
  ...
  public:
    template <typename... Ts>
    TInterface(Ts... args) : T(args...), _count(0) {}
...
class TInterfaceEx : public T {
  ...
  public:
    template <typename... Ts>
    TInterfaceEx(Ts... args) : T(args...), _bus(nullptr), _count(0) {}
...
class TBus : public IBus {
  ...
  public:
    ...
    virtual void _setBus(IBus *bus) override { /* unused */ }
